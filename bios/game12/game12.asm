...
TilesCompressed:
dw SwampTile, MudTile, SomeGrassTile, DenseGrassTile, BushTile, TreeTile, MountainTile, BushCoverSprite ; 7
...
dw PlatformSprite, House1Sprite, House2Sprite, House3Sprite ; 27
