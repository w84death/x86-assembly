...
db COLOR_BLACK, COLOR_WHITE, COLOR_LIGHT_BLUE, COLOR_BLUE ; Egg
...
dw 0000010110011001b, 1101110110000000b
dw 0000110101010111b, 1010111110000000b
dw 0000110111101011b, 1001111010000000b
dw 0000110101111011b, 1111111010000000b
dw 0000100110111111b, 0110110110000000b
