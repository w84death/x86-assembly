...
dw TrainCHSprite, TrainBHSprite, TrainAHSprite, TrainCVSprite, TrainBVSprite, TrainAVSprite
TilesCompressedEnd:
...
db COLOR_BLACK, COLOR_YELLOW, COLOR_ORANGE, COLOR_LIGHT_GRAY; Egg
db COLOR_BLACK, COLOR_ORANGE, COLOR_ORANGE_BROWN, COLOR_BROWN ; Worm
db COLOR_BLACK, COLOR_LIGHT_BLUE,COLOR_SKY_BLUE, COLOR_DARK_TEAL ; Beetle
db COLOR_BLACK, COLOR_DARK_BLUE, COLOR_BROWN, COLOR_WHITE ; Spider
db COLOR_BLACK, COLOR_WHITE, COLOR_YELLOW, COLOR_RED ; Insect
db COLOR_BLACK, COLOR_BLUE, COLOR_BROWN, COLOR_RED ; Flower 0A
db COLOR_BLACK, COLOR_BLUE, COLOR_GREEN, COLOR_YELLOW ; Ogor 0B
db COLOR_BLACK, COLOR_LIGHT_GRAY, COLOR_BROWN, COLOR_ORANGE ; House 0C
db COLOR_BLACK, COLOR_DARK_TEAL, COLOR_ORANGE, COLOR_YELLOW ; Train 0D
