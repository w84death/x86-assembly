...
TILE_RESOURCE_BLUE      equ 33
TILE_RESOURCE_ORANGE    equ 36
...
draw_ui:
   ...
   mov si, FakeNumberText  ; Railroad
   mov dx, 0x01504
   mov bl, COLOR_WHITE
   call draw_text

   mov di, UI_FIRST_LINE+76
   mov al, TILE_RESOURCE_ORANGE
   call draw_sprite

   mov si, FakeNumberText  ; Resource orange
   mov dx, 0x0150C
   mov bl, COLOR_WHITE
   call draw_text
   ...
   mov si, FakeNumberText  ; Resource blue
   mov dx, 0x01514
   mov bl, COLOR_WHITE
   call draw_text
...
dw CursorBuildSprite, GloopendraSprite, MycelurkSprite, VenomireSprite, WhirlygigSprite, OgorSprite ; 5
...
db 0x0, 0x2, 0xD, 0xF ; Palette 0x6
...
dw 0000000000011010b, 1010010000000000b
dw 0000000101011011b, 1111010101000000b
dw 0000011011011011b, 1111011110010000b
dw 0000011111010101b, 0101011110010000b
dw 0001101111011111b, 1010011110100100b
dw 0001101111111110b, 1010101110100100b
dw 0001101101111110b, 1010110110100100b
dw 0001101101110101b, 0101110110010100b
dw 0001011001011010b, 1010010101100100b
...
House3Sprite:
db 0x15
dw 0000000000010101b, 0100000000000000b
dw 0000000000011010b, 1010010011010000b
dw 0000000001011011b, 1111101101010000b
dw 0000000001011011b, 1010110101000000b
dw 0000000001011010b, 1011010101000000b
dw 0000000001011011b, 1010011010010000b
dw 0000000000010111b, 1010101010100100b
dw 0000000001110101b, 1110101010110100b
dw 0000000101111001b, 0111101010110100b
dw 0000011001101010b, 0101101011100100b
dw 0001110101100110b, 1011010101010100b
dw 0001100101100101b, 0111010101000000b
dw 0000011001010101b, 0110010000000000b
dw 0000000111111010b, 0101000000000000b
dw 0000000001010101b, 0100000000000000b
dw 0000000000000000b, 0000000000000000b
